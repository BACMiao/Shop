...
<body>
	<div id="s_hdw">
		...
		<div id="s_tbar">
			<div class="s_hd">
				<div class="tbar_lft">
                        欢迎您：<s:property value="#session.user.userName"/> 这里是集大纸飞机！
				...
				<div class="tbar_rgt">
					<ul>
						...
						<li><a href="javascript:void(0);" onclick="AddFavorite('集大纸飞机','http://localhost:8080')">加入收藏</a></li>
		...
		<div class="mmenu">
			<div class="s_hd">
				...
				<div id="s_cart">
					<ul>
						<li class="nums"><a href="" id="s_cart_nums1">购物车：</a> <a href="#" onClick="myCart();return false;" class="btn" id="s_cart_nums2"></a></li>
...
<div id="MainCenter" align="center" class="MainCenter" >
				               ...
				               <c:forEach items="${requestScope.goodsNoTejiaList}" var="goods" varStatus="sta">
				                  ...
				                  <td align="center">
									   <a href="<%=path %>/goodsDetailQian.action?goodsId=${goods.goodsId }">  
									      <img width="130" height="130" src="${goods.goodsPic }" style="border:1px solid #ccc; padding:3px;"/>
		 ...
		 <div class="NewContainer770" >
				<div class="BoxHeader">
				    <div class="BoxHeader-center MarginTop10">
						<span style="float:left">特价商品</span>
