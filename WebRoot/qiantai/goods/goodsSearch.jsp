						...
						<table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
				              <tr align="center" bgcolor="#FAFAF1" height="22">
								  ...
								  <tr align='center' bgcolor="#FFFFFF" height="22">
									  ...
									  <td><a href="<%=path %>/goodsDetailQian.action?goodsId=<s:property value="#goods.goodsId"/>"> <img style="border:1px solid #ccc; padding:3px;" src="<s:property value="#goods.goodsPic"/>" width="60" height="60" border="0"/> </a></td>
