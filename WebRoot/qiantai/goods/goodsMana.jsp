...
<!--我的发布动作-->
        ...
        <script language="javascript">
           ...
           function goodsFly(goodsId)
           {
               if(confirm('您确定起飞吗？'))
               {
                   window.location.href="<%=path %>/goodsFly.action?goodsId="+goodsId;
               }
           }
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                    ...
                    <td bgcolor="#FFFFFF" align="center">
                        <a href="#" style="color: #8CB2FD" onclick="goodsFly(<s:property value="#goods.goodsId"/>)" class="pn-loperator">起飞</a>&nbsp;&nbsp;
                        <a href="#" style="color: red" onclick="goodsDel(<s:property value="#goods.goodsId"/>)" class="pn-loperator">删除</a>
                    </td>
				</tr>
				</s:iterator>
			</table>
		...
		<div id="s_ft">
			...
			<div class="copyright tac pbt10">版权所有 炫酷纸飞机 版权所有 <a href="#">纸飞机</a>首页 </div>
